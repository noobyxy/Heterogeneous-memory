...
Note:  CCTLib *NOW* redestributes google hash tables (Sparsehash) source from
http://code.google.com/p/sparsehash/, Boost C++ library version 1_56_0 and libelf.
...
This produces libcctlib.a and libcctlib_tree_based.a in the src directory (refer to http://www.cs.rice.edu/~mc29/Milind/Publications_files/paper.pdf for details).
